...
###Load core of theme###
function lumise_is_plugin_active( $plugin ){
...
function lumise_incl_core( $file = '', $type = 'ro', $atts = array(), $content = '' ){
...
lumise_incl_core( trailingslashit('core').'lumise.define.php' );


//Register new path shortcode with mini
add_action('init', 'lumise_set_shortcode_template', 99 );
function lumise_set_shortcode_template(){
