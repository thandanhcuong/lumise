 ...
 */
	...
	$more = lumise_theme::globe('more');

	$thumbnail_url = $lumise_theme->get_featured_image( $post );
	//$thumbnail_url = lumise_createLinkImage( $thumbnail_url, '831x369xc' );

	$categories_list = get_the_category_list( ', ' );
	$post_custom_field = get_post_meta($post->ID , '_'.LUMISETHEME_OPTNAME.'_post_meta_options', true);
	$noimg = true;
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
	...
	<div class="entry-content">
		...
		<div class="title">
			...
			<ul class="post-meta">
				<li><?php echo esc_html__( 'Written by:', 'lumise' ); ?> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php echo get_the_author(); ?></a>
				</li>
