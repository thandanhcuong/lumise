				...
				<div class="col-md-9 content_left">
					<div class="main-content">
						...
						<?php if ( have_posts() ) : ?>
							...
							<header>
								<h1 class="page-title author"><?php echo esc_html__( 'Author: ', 'lumise' ) . '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>'; ?></h1>
							</header>
							...
							<?php if (get_the_author_meta('description')) : ?>
								<div class="about-author">
									<h3 class="author-name"><?php echo esc_html__( 'About ', 'lumise' ) . get_the_author(); ?></h3>
									<figure>
